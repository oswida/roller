import { CsTemplate, RollDefInfo, rollDef, setChatViewTab, setMainViewPanel } from "~/common";
...
export const addAttrControl = (canvas: fabric.Canvas, obj: fabric.Object, tpl: CsTemplate) => {
