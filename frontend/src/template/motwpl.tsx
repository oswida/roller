...
const genBasicMoves = () => {
  return [
    ...
    },
    {
      ...
      itype: "label",
      description: "Działaj pod presją",
      ...
      items: [
        {
          ...
          itype: "label",
          description: "Normalne bronie",
        },
        {
          id: "bron_1",
          name: "rewolwer",
          description: "Rewolwer kaliber .38",
          itype: "check",
        ...
        },
        {
          ...
          description: "Strzelba myśliwska",
          itype: "check",
        ...
        },
        {
          ...
          name: "Ukryte bronie",
          itype: "label",
          description: "Ukryte bronie",
        },
        {
          id: "bron_7",
          name: "Noże do rzucania",
          description: "Noże do rzucania",
          itype: "check",
        ...
        },
        {
          ...
          description: "Pistolet kieszonkowy",
          itype: "check",
        ...
        },
        {
          ...
          description: "Ciężkie rękawice/mosiężne kastety",
          itype: "check",
        ...
        },
        {
          ...
          description: "Nóż motylkowy/składany",
          itype: "check",
      ...
      items: [
        {
          ...
          name: "rozwiniecia",
          itype: "label",
          description: "Rozwinięcia",
          hint: "Gdy rozwiniesz się pięć razy możesz wybierać rozwinięcia zaawansowane.\nSą opisane poniżej.",
        },
        {
          id: "rp_1",
          name: "rp1",
          description: "Dodaj +1 do Sprytu, maks. +3",
          itype: "check",
        },
        {
          id: "rp_2",
          name: "rp2",
          description: "Dodaj +1 do Hartu, maks. +2",
          itype: "check",
        },
        {
          id: "rp_3",
          name: "rp3",
          description: "Dodaj +1 do Spokoju, maks. +2",
          itype: "check",
        },
        {
          id: "rp_4",
          name: "rp4",
          description: "Dodaj +1 do Uroku, maks. +2",
          itype: "check",
        },
        {
          id: "rp_5",
          name: "rp5",
          description: "Weź nowy ruch Spiskologa",
          itype: "check",
        },
        {
          id: "rp_6",
        ...
        },
        {
          ...
          name: "rp7",
          description:
            "Uzyskaj Siedzibę, taką jak ma Ekspert, z dwiema opcjami",
          itype: "check",
        },
        {
          id: "rp_8",
          name: "rp8",
          description: "Dodaj do swojej Siedziby jeszcze jedną opcję",
          itype: "check",
        },
        {
          id: "rp_9",
          name: "rp9",
          description: "Weź ruch innej Roli",
          itype: "check",
        },
        {
          id: "rp_10",
        ...
        },
        {
          ...
          name: "rozwiniecia2",
          itype: "label",
          description: "Rozwinięcia zaawansowane",
        },
        {
          id: "rp_11",
          name: "rp11",
          description: "Dodaj +1 do dowolnego współczynnika, maks. +3.",
          itype: "check",
        },
        {
          id: "rp_12",
          name: "rp12",
          description: "Zmień Rolę tego łowcy",
          itype: "check",
        },
        {
          id: "rp_13",
          name: "rp13",
          description: "Stwórz innego Łowcę i graj nim razem z tym",
          itype: "check",
        },
        {
          id: "rp_14",
          name: "rp14",
          description: "Oznacz dwa podstawowe ruchy jako zaawansowane.",
          itype: "check",
        },
        {
          id: "rp_15",
        ...
        },
        {
          id: "rp_16",
          name: "rp16",
          description: "Wyślij tego Łowcę na bezpieczną emeryturę",
          itype: "check",
        },
      ],
    },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Anielskie skrzydła",
          itype: "check",
      ...
      items: [
        {
          id: "zad1",
          name: "zad1",
          description: "Masz zwalczać tu machinacje jakiegoś Adwersarza.",
          itype: "check",
        },
        {
          id: "zad2",
        ...
        },
        {
          ...
          name: "zad4",
          description:
            "Zostałeś wygnany. Musisz pracować w imię Dobra bez zwracania na siebie uwagi twoich braci i sióstr, bo oni mają obowiązek stracić cię za twoje zbrodnie.",
          itype: "check",
        },
        {
          id: "zad5",
          name: "zad5",
          description:
            "Jeden z pozostałych Łowców ma kluczową rolę do odegrania w nadchodzących wydarzeniach. Musisz przygotować go na tę rolę i bronić za wszelką cenę.",
          itype: "check",
        },
      ],
    },
      ...
      items: [
        {
          ...
          name: "Boska broń",
          itype: "label",
          description: "Boska broń",
        },
        {
          id: "bron_1",
          name: "Gorejący miecz",
          description: "Gorejący miecz",
          itype: "check",
        ...
        },
        {
          ...
          description: "Torba Pięciu Demonów",
          itype: "check",
        ...
        },
        {
          ...
          color: "currentcolor",
          description:
            "Masz też boski pancerz (1-pancerz święty). Wygląda adekwatnie do twojego niebiańskiego pochodzenia",
        },
        {
          id: "bron_6",
          name: "Kieł narwala",
          description: "Kieł narwala (za zgodą Strażnika)",
          itype: "check",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          id: "rp_1",
          name: "rp1",
          description: "Dodaj +1 do Hartu, maks. +3",
          itype: "check",
        },
        {
          id: "rp_2",
        ...
        },
        {
          id: "rp_4",
          name: "rp4",
          description: "Dodaj +1 do Sprytu, maks. +2",
          itype: "check",
        },
        {
          id: "rp_5",
          name: "rp5",
          description: "Dodaj +1 do Dziwu, maks. +2",
          itype: "check",
        },
        {
          id: "rp_6",
          name: "rp6",
          description: "Weź nowy ruch Niebianina",
          itype: "check",
        },
        {
          id: "rp_7",
        ...
        },
        {
          ...
          name: "rp8",
          description:
            "Uzyskaj sojusznika – pomniejsze niebiańskie stworzenie zesłane, by pomóc w Twojej misji",
          itype: "check",
        },
        {
          id: "rp_9",
        ...
        },
        {
          id: "rp_17",
          name: "rp17",
          description: "Wymaż wypełnienie jednego z pól Fuksa",
          itype: "check",
        },
        {
          id: "rp_18",
          name: "rp18",
          description:
            "Zmień swoją misję. Wybierz inną z normalnych opcji lub (za zgodą Strażnika) wymyśl własną.",
          itype: "check",
        },
      ],
    },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Wszystko przewidziałem",
          itype: "check",
        ...
        },
        {
          ...
          description: "Mroczna przeszłość",
          itype: "check",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Magiczna pracownia",
          itype: "check",
      ...
      items: [
        {
          ...
          itype: "label",
          description: "Bronie na potwory",
        },
        {
          id: "bron_1",
          name: "Młotek i drewniane kołki",
          description: "Młotek i drewniane kołki",
          itype: "check",
        ...
        },
        {
          ...
          description: "Miecz z zimnego żelaza",
          itype: "check",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          id: "rp_5",
          name: "rp5",
          description: "Weź nowy ruch Eksperta",
          itype: "check",
        },
        {
          id: "rp_6",
        ...
        },
        {
          id: "rp_7",
          name: "rp7",
          description: "Dodaj nową opcję do swojej Siedziby",
          itype: "check",
        },
        {
          id: "rp_8",
