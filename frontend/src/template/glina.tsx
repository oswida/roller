  ...
  sections: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          name: "Słabość",
          itype: "big_text",
          hint: "Wybierz jedną z poniższych słabości i wymyśl jej szczegóły.\n Bunt, choroba, dociekliwość, grzechy ojców, kryzys wiary, lęk, lojalność, miłość, pakt, pokusa, PTSD, pycha, spisek, ucieczka, wojna, wyrok, zbrodnia, zdrada, zemsta, zwątpienie.",
        },
        {
          id: "wazne_miejsce",
          name: "Ważne miejsce",
      ...
      items: [
        {
          ...
          itype: "check_circle",
          text: "„Wituś” – uchol",
          hint: "Może wyciągnął cię\nz opresji lub wie o tobie więcej, niż powinien?",
        },
        {
          id: "wisniewska",
          name: "Wiśniewska",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          itype: "check_circle",
          text: "Amant",
          hint: "gdy spędzasz noc z kochankiem lub kochanką, wykonaj rzut + osobowość.\n- Triumf: Usuń 1 stresu oraz zadaj dwa pytania:\n• Co wiesz o...?\n• Czego chcesz od...?\n• Co planuje...?\nFuks: Zadaj dwa pytania z listy powyżej.\nSkucha: Dopuszczasz tę osobę za blisko, a ona odkrywa twój sekret, nim zdążysz zainterweniować. Otrzymujesz +1 stresu.",
        },
      ],
    },
    {
