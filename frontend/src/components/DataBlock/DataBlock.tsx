...
export const DataBlock: Component<Props> = (
    { left, right, leftBackground, rightBackground, leftFunc, rightFunc, widthLeft, widthRight, width }) => {
    ...
    return <Flex style={{ "justify-content": "space-between", width: width }} gap="none">
        <Show when={left || leftFunc}>
            <div
                style={{ width: widthLeft ? widthLeft : (right || rightFunc ? "50%" : undefined) }}
        ...
        <Show when={right || rightFunc}>
            <div
                style={{ width: widthRight ? widthRight : (left || leftFunc ? "50%" : undefined) }}
